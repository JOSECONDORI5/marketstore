...
import {
  ...
  ChangePassword, ConfirmEmailVerification,



  ConfirmPasswordReset, GetUserData, Login, Register,
...
export class UsersService {
  ...
  private changePassword: string = ChangePassword.url;
	...
	registerAuth(user: UsersModel){
		...
		return this.http.post<UsersModel>(`${this.register}`, user);
	...
	registerDatabase(user: UsersModel){
  	...
  	sendEmailVerificationFnc(body: object){
  		...
  		return this.http.post<UsersModel>(`${this.sendEmailVerification}`, body);
  	...
  	confirmEmailVerificationFnc(body: object){
  		...
  		return this.http.post<any>(`${this.confirmEmailVerification}`, body);
  	...
  	patchData(id: string, value: object){
		...
		return this.http.patch<any>(`${this.api}users/${id}.json`, value);
	...
	=============================================*/
  	...
  	sendPasswordResetEmailFnc(body: object){
  		...
  		return this.http.post<any>(`${this.sendPasswordResetEmail}`, body);
	...
	=============================================*/
  	...
  	verifyPasswordResetCodeFnc(body: object){
  		...
  		return this.http.post<any>(`${this.verifyPasswordResetCode}`, body);
	...
	=============================================*/
  	...
  	confirmPasswordResetFnc(body: object){
  		...
  		return this.http.post<any>(`${this.confirmPasswordReset}`, body);
    			...
    			for (const i in resp){
    				...
    				/*=============================================
      				...
      				if (resp[i].wishlist != undefined){
      					...
      					const wishlist = JSON.parse(resp[i].wishlist);
